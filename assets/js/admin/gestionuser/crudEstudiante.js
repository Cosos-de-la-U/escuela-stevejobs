...
const fingresarEstudiante = (nombre, fechNacimiento, sexo, user, password, grado, email) =>
    db.collection('estudiante').doc().set({
        nombre, fechNacimiento, sexo, user, password, grado, email
    });
